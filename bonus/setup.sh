...
log_info "Password: Récupérer avec la commande:"
log_info "  kubectl get secret gitlab-gitlab-initial-root-password -n gitlab -o jsonpath='{.data.password}' | base64 -d && echo"
log_info ""
log_info "============================================"
